...
from .views import ShopViewSet, UserViewSet, DoctorViewSet, ServiceViewSet, ServicedetailDayViewSet, \
    ...
    UserProfileUpdateViewSet,AppointmentViewSet,DoctorshopAppointmentViewSet,OTPVerify,PaymentView,PaymentSuccess,Rechargeviewset,\
...
urlpatterns = [
    ...
    path('recharge',Rechargeviewset.as_view({'post':'recharge'}),name='recharge'),
